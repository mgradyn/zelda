...
class Level:
    ...
    def create_map(self):
        ...
        graphics = {
            ...
            'objects': import_folder_asc('./graphics/Objects'),
        }
    ...
    def cooldowns(self, player):
        ...
        if player.death_trigger and not player.isdead:
            if current_time - player.death_time >= player.death_duration:
                player.isdead = True
    ...
    def toggle_menu(self):
        ...
        self.game_freeze = not self.game_freeze
