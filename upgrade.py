...
class Upgrade:
    ...
    def display(self):
        ...
        bg = pygame.Surface(self.display_surface.get_size())
        bg.set_alpha(128)               
        bg.fill('black')           
...
class Item:
    ...
    def trigger(self,player):
        ...
        can_upgrade =  player.stats[upgrade_attribute] < player.max_stats[upgrade_attribute]

        if player.exp >= player.upgrade_cost[upgrade_attribute] and can_upgrade:
    ...
    def display(self, surface, selection_num, name, value, max_value, cost):
        ...
        self.display_name(surface,name,cost,selected)
