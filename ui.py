...
class UI:
    ...
    def weapon_overlay(self, weapon_index, has_switched):
        bg_rect = self.selection_box(13, self.display_surface.get_size()[1] - 13 - ITEM_BOX_SIZE, has_switched)
    ...
    def magic_overlay(self, magic_index, has_switched):
        bg_rect = self.selection_box(ITEM_BOX_SIZE + 3, self.display_surface.get_size()[1] - 7 - ITEM_BOX_SIZE, has_switched)
